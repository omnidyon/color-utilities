...
export const isValidColor = (space: string, color: { [key: string]: number }): boolean => {
  ...
  const validators = {
    ...
    // CMYK/CMY
    cmy: (c: { [key: string]: number }) =>
      hasProps(c, ["cyan", "magenta", "yellow"]) && inRange(c.cyan, 0, 100) && inRange(c.magenta, 0, 100) &&
      inRange(c.yellow, 0, 100),
    cmy_m: (c: { [key: string]: number }) =>
      hasProps(c, ["c", "m", "y"]) && inRange(c.c, 0, 100) && inRange(c.m, 0, 100) && inRange(c.y, 0, 100),
    cmyk: (c: { [key: string]: number }) =>
    ...
    lch: (c: { [key: string]: number }) =>
      hasProps(c, ["lightness", "chroma", "hue"]) && inRange(c.lightness, 0, 100) && inRange(c.hue, 0, 360),
    lch_m: (c: { [key: string]: number }) =>
      hasProps(c, ["l", "c", "h"]) && inRange(c.l, 0, 100) && inRange(c.h, 0, 360),
    // Other color spaces
    hcl: (c: { [key: string]: number }) =>
      hasProps(c, ["hue", "chroma", "luminance"]) && inRange(c.hue, 0, 360) && inRange(c.luminance, 0, 100),
    hcl_m: (c: { [key: string]: number }) =>
      hasProps(c, ["h", "c", "l"]) && inRange(c.h, 0, 360) && inRange(c.l, 0, 100),
