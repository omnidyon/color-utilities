...
export class Blender {
  constructor(color1, color2, options) {
    ...
    this.rgb1 = type1 === "rgb" ? color1 : toRgbConverters[getColorType(color1)](color1);
    this.rgb2 = type2 === "rgb" ? color2 : toRgbConverters[getColorType(color2)](color2);
    const weight = options.weight ? options.weight : 0.5;
    this.color = options.returnType === "rgb" || !options.returnType
      ? blend(this.rgb1, this.rgb2, weight)
      : (colorConverters[options.returnType]
