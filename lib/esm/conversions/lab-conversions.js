 ...
 */
export const oklabToOKLCH = (oklab) => {
 ...
 */
export const oKLabToSRGB = (oklab) => {
  const LMS_c = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.OKLab_TO_LMS, {
    luminance: oklab.luminance,
    a: oklab.a,
    b: oklab.b,
  }, ["L", "M", "S"]);
  const LMS = {
  ...
  const linearRGB = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.LMS_TO_Linear_RGB, LMS, [
    "red",
    "green",
    "blue",
  ]);
