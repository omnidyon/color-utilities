...
export const yCbCrBT601ToSrgb = ({ Y, Cb, Cr }) => {
  const { red, green, blue } = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.BT_601_YCBCR_TO_RGB, {
    Y: Y - 16,
    Cb: Cb - 128,
    Cr: Cr - 128,
  }, ["red", "green", "blue"]);
...
export const yCbCrBT709ToSrgb = ({ Y, Cb, Cr }) => {
  const { red, green, blue } = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.BT_709_YCBCR_TO_RGB, {
    Y,
    Cb,
    Cr,
  }, ["red", "green", "blue"]);
