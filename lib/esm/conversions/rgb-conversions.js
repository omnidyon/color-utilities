 ...
 */
export const sRGBToLinear = (srgb) => {
 ...
 */
export const linearToSRGB = (linerRgb) => {
 ...
 */
export const linearValToSRGBVal = (val) => {
...
export const sRgbToCmyk = (rgb, round) => {
  ...
  const K1 = 1 - key;
  const f = (t) => round ? Math.round((K1 && (K1 - t) / K1) * 100) : (K1 && (K1 - t) / K1) * 100;
...
export const sRgbToYCbCrBT601 = ({ red, green, blue }) => {
  const { Y, Cb, Cr } = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_YCBCR_BT_601, {
    red,
    green,
    blue,
  }, ["Y", "Cb", "Cr"]);
...
export const sRgbToYCbCrBT709 = ({ red, green, blue }) => {
  return matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_BT_709_YCBCR, { red, green, blue }, [
    "Y",
    "Cb",
    "Cr",
  ]);
...
export const sRGBToOKLCH = (srgb) => {
  ...
  const LMS = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_LMS, linearRGB, ["L", "M", "S"]);
  const LMS_c = {
    L: Math.cbrt(LMS.L),
    M: Math.cbrt(LMS.M),
    S: Math.cbrt(LMS.S),
  };
  const OKLab = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.LMS_c_TO_OKLab, LMS_c, ["L", "A", "B"]);
